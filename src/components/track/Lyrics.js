...
import Spinter from "../layouts/Spinter";
...
export default class Lyrics extends Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.get?track_id=${this.props.match.params.id}
           &apikey=${process.env.REACT_APP_MM_KEY}`
    )
      .then((result) => result.json())
      .then((result) => {
    ...
    if (
      ...
      return (
        <React.Fragment>
          ...
          <ul className="list-item mt-3 pl-0">
            ...
            <li className="list-group-item">
              <strong>Num of Vaforites : </strong>
              {track.num_favourite}
            </li>
            <li className="list-group-item">
